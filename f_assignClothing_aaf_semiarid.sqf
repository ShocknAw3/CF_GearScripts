// Backpacks
_backpackRegSemiArid = "rhs_sidor";
_backpackARSemiArid = "B_TacticalPack_rgr";
_backpackAARSemiArid = "B_TacticalPack_rgr";
...
// Vests
_VestRegSemiArid = "LOP_V_CarrierLite_OLV";
_vestSFSemiArid = "LOP_V_CarrierLite_OLV";
_vestSNSemiArid = "LOP_V_CarrierLite_OLV";
_vestSPSemiArid = "LOP_V_CarrierLite_OLV";
...
_listUniforms = [
				...
				["LOP_U_BH_Fatigue_CHOCO", "LOP_U_BH_Fatigue_CHOCO_TRI", "LOP_U_BH_Fatigue_CHOCO_FWDL", "LOP_U_BH_Fatigue_CHOCO_LIZ", "LOP_U_BH_Fatigue_CHOCO_M81"],
				...
				["LOP_U_BH_Fatigue_GUE_TRI_TAN", "LOP_U_BH_Fatigue_GUE_FWDL", "LOP_U_BH_Fatigue_GUE_M81_OLV"],
				...
				["LOP_U_BH_Fatigue_OFI_TRI", "LOP_U_BH_Fatigue_OFI_FWDL", "LOP_U_BH_Fatigue_OFI_LIZ", "LOP_U_BH_Fatigue_OFI_M81"], 
				["LOP_U_IRA_Fatigue_DPM_GNSW", "LOP_U_IRA_Fatigue_DPM_BSW", "LOP_U_IRA_Fatigue_DPM_GSW", "LOP_U_IRA_Fatigue_DPM_TSW"],
				["LOP_U_ISTS_Fatigue_13", "LOP_U_ISTS_Fatigue_17", "LOP_U_ISTS_Fatigue_18", "LOP_U_ISTS_Fatigue_20", "LOP_U_ISTS_Fatigue_21", "LOP_U_ISTS_Fatigue_22", "LOP_U_ISTS_Fatigue_23", "LOP_U_ISTS_Fatigue_24", "LOP_U_ISTS_Fatigue_26", "LOP_U_ISTS_Fatigue_25", "LOP_U_ISTS_Fatigue_27", "LOP_U_ISTS_Fatigue_28"],
...
_listHeadgear = [
				...
				["LOP_H_Beanie_dpmw", "LOP_H_Beanie_flec", "LOP_H_Beanie_m81", "LOP_H_Beanie_marpat", "LOP_H_Beanie_multicam", "LOP_H_Beanie_tan", "rhs_beanie", "rhs_beanie_green"],
				["H_Bandanna_gry", "H_Bandanna_blu", "H_Bandanna_cbr", "H_Bandanna_khk", "H_Bandanna_sgg", "H_Bandanna_sand", "H_Bandanna_camo", "rhssaf_bandana_digital", "rhssaf_bandana_md2camo", "rhssaf_bandana_oakleaf", "rhssaf_bandana_smb", "rhs_xmas_antlers"],
				["H_Booniehat_khk", "H_Booniehat_oli", "H_Booniehat_tan", "H_Booniehat_tna_f", "rhs_booniehat_m81", "rhs_booniehat2_marpatwd", "rhssaf_booniehat_digital", "rhssaf_booniehat_md2camo", "rhssaf_booniehat_woodland"],
				...
				["H_hat_brown", "H_hat_camo", "H_hat_grey", "H_hat_tan", "H_strawhat", "H_strawhat_dark"],
				["H_Shemag_olive", "H_ShemagOpen_tan", "LOP_H_Shemag_BLK", "LOP_H_Shemag_BLU", "LOP_H_Shemag_GRE", "LOP_H_Shemag_OLV", "LOP_H_Shemag_TAN"]
				];
...
// LOADOUT: AUTOMATIC RIFLEMAN
	case "iar":
	{
		_unit addBackpack _backpackARSemiArid;
		_unit addVest _vestRegSemiArid;
...
// LOADOUT: ASSISTANT AUTOMATIC RIFLEMAN
	case "iaar":
	{
		_unit addBackpack _backpackAARSemiArid;
		_unit addVest _vestRegSemiArid;
...
// LOADOUT: SF RADIO OPERATOR
	case "iffro":
	{
		_unit addBackpack _backpackSFROSemiArid;
		_unit addVest _vestSFSemiArid;
