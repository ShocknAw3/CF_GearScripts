...
// Markers seen by players in NATO slots.
	...
	case "blu_f":
	{
		...
		["GrpNATO_PL", 0, "PL", "ColorBlue"] spawn f_fnc_localGroupMarker;
		...
		["GrpNATO_M1", 2, "M1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpNATO_M2", 2, "M2", "ColorOrange"] spawn f_fnc_localGroupMarker;
		
		["GrpNATO_L1", 3, "L1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpNATO_L2", 3, "L2", "ColorOrange"] spawn f_fnc_localGroupMarker;
		
		["GrpNATO_Q1", 3, "Q1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpNATO_Q2", 3, "Q2", "ColorOrange"] spawn f_fnc_localGroupMarker;
		
		["GrpNATO_N1", 3, "N1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpNATO_N2", 3, "N2", "ColorOrange"] spawn f_fnc_localGroupMarker;
		
		["GrpNATO_F1", 7, "F1", "ColorGreen"] spawn f_fnc_localGroupMarker;
  		["GrpNATO_F2", 7, "F2", "ColorGreen"] spawn f_fnc_localGroupMarker;
		
		["GrpNATO_G1", 9, "G1", "ColorGreen"] spawn f_fnc_localGroupMarker;
  		["GrpNATO_G2", 9, "G2", "ColorGreen"] spawn f_fnc_localGroupMarker;
		
		["GrpNATO_SF1", 0, "SF1", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpNATO_SF2", 0, "SF2", "ColorBlack"] spawn f_fnc_localGroupMarker;
		
		["GrpNATO_S1", 4, "S1", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpNATO_S2", 4, "S2", "ColorBlack"] spawn f_fnc_localGroupMarker;
...
// Markers seen by players in CSAT slots.
	...
	case "opf_f":
	{
		...
		["GrpCSAT_PL", 0, "PL", "ColorBlue"] spawn f_fnc_localGroupMarker;
		...
		["GrpCSAT_M1", 2, "M1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_M2", 2, "M2", "ColorOrange"] spawn f_fnc_localGroupMarker;
		
		["GrpCSAT_L1", 3, "L1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_L2", 3, "L1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		
		["GrpCSAT_F1", 7, "F1", "ColorGreen"] spawn f_fnc_localGroupMarker;
  		["GrpCSAT_F2", 7, "F2", "ColorGreen"] spawn f_fnc_localGroupMarker;
		
		["GrpCSAT_G1", 9, "G1", "ColorGreen"] spawn f_fnc_localGroupMarker;
  		["GrpCSAT_G2", 9, "G2", "ColorGreen"] spawn f_fnc_localGroupMarker;
		
		["GrpCSAT_SF1", 0, "SF1", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_SF2", 0, "SF2", "ColorBlack"] spawn f_fnc_localGroupMarker;
		
		["GrpCSAT_S1", 4, "S1", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_S2", 4, "S2", "ColorBlack"] spawn f_fnc_localGroupMarker;
...
// Markers seen by players in AAF slots.
	...
	case "ind_f":
	{
		...
		["GrpAAF_PL", 0, "PL", "ColorBlue"] spawn f_fnc_localGroupMarker;
		...
		["GrpAAF_M1", 2, "M1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpAAF_M2", 2, "M2", "ColorOrange"] spawn f_fnc_localGroupMarker;
		
		["GrpAAF_L1", 3, "L1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpAAF_L2", 3, "L1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		
		["GrpAAF_F1", 7, "F1", "ColorGreen"] spawn f_fnc_localGroupMarker;
  		["GrpAAF_F2", 7, "F2", "ColorGreen"] spawn f_fnc_localGroupMarker;
		
		["GrpAAF_G1", 9, "G1", "ColorGreen"] spawn f_fnc_localGroupMarker;
  		["GrpAAF_G2", 9, "G2", "ColorGreen"] spawn f_fnc_localGroupMarker;
		
		["GrpAAF_FF1", 0, "SF1", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpAAF_FF2", 0, "SF2", "ColorBlack"] spawn f_fnc_localGroupMarker;
		
		["GrpAAF_S1", 4, "S1", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpAAF_S2", 4, "S2", "ColorBlack"] spawn f_fnc_localGroupMarker;
